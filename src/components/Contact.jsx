...
const Contact = () => {
  ...
  return (
    ...
    >
      <SectionTitle text={text.contact.title} />
      <motion.div
        ...
        viewport={{ once: true }}
      >
        <a href={text.contact.email.link} className="flex flex-col gap-2">
          <div className="flex items-center gap-2 w-max bg-green-500 text-neutral-100 px-4 py-1 rounded">
            ...
            <span className="font-medium upper">
              {text.contact.email.label}
            </span>
          </div>
          <p>{text.contact.email.address}</p>
        </a>

        <a href={text.contact.telegram.link} className="flex flex-col gap-2">
          <div className="flex items-center gap-2 w-max bg-[#37aee2] text-neutral-100 px-4 py-1 rounded">
            ...
            <span className="font-medium upper">
              {text.contact.telegram.label}
            </span>
          </div>
          <p>{text.contact.telegram.username}</p>
        </a>
      </motion.div>
    </section>
  );
